  ...
  template: `
    <div class="min-h-screen bg-black relative overflow-hidden">
      ...
      <section class="px-5 pb-16 max-w-md mx-auto text-center fade-in">
        ...
        <p class="text-sm text-gray-400 mb-6">Escribinos por WhatsApp y te asesoramos sobre la mejor membresía para vos.</p>
        <a [href]="whatsappUrl('Hola! Quiero información sobre las membresías')" target="_blank"
           class="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-sm font-semibold text-white btn-whatsapp">
