...
const CODES = Array.from({ length: 100 }, (_, i) => `BEJ-${String(i + 101).padStart(4, '0')}`);
const INPUT = 'img/frente.jpg';

// Original: 2462x1728. Scale to ~50%
const SCALE = 0.5;
...
(async () => {
  ...
  console.log('\n✓ 100 tarjetas generadas (BEJ-0101 a BEJ-0200)');
})();
